...
function updateModels() {
  ...
  if (selectedBrand && data[selectedBrand]) {
    for (const model in data[selectedBrand]) {
      const option = document.createElement("option");
      option.value = model;
...
function searchMobile() {
  ...
  if (selectedBrand && selectedModel) {
    const mobileData = data[selectedBrand][selectedModel];
    if (mobileData) {
      ...
      card.innerHTML = `
            ...
            <ul>
              <li><strong>Processor:</strong> ${mobileData.processor}</li>
              <li><strong>RAM:</strong> ${mobileData.memory.ram}GB</li>
              <li><strong>Storage:</strong> ${mobileData.memory.storage}GB</li>
              <li><strong>Battery:</strong> ${mobileData.battery}mAh</li>
              <li><strong>OS:</strong> ${mobileData.operatingSystem}</li>
              <li><strong>Features:</strong> ${mobileData.specialFeatures.join(
                ", "
              )}</li>
            </ul>
          `;
